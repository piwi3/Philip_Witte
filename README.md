...
## [2: Deploying a movie recommender app with Flask & Heroku using Non-negative Matrix Factorization (NMF)](https://github.com/piwi3/nmf_movie_recommender)
...
<img src="https://github.com/piwi3/Philip_Witte/blob/main/images/scrsht_movie_recommender.png?raw=true" width="600"><br/>
_Figure 2: Frontend of movie recommender app (main page) built with flask and bootstramp_


## [3: Simulation of customer movement in a supermarket with pygame & Markov chains](https://github.com/piwi3/timeseries_analysis_temperature)
...
_Figure 3: A few seconds of the built supermarket simulation/visualization in pygame_
    
    
## [4: Sentiment analysis of twitter tweets via dockerized pipeline](https://github.com/piwi3/dockerized_twitter_app)
...
_Figure 4: Frontend of my twitter sentiment app (created with streamlit)_


## [5: Prediction of survival on the Titanic using ML classification models](https://github.com/piwi3/classification_with_titanic_data)
...
_Figure 5: Main KPIs for implemented ML classifiers_


## [6: Prediction of bike rentals using ML regression models](https://github.com/piwi3/prediction_of_bike_rentals)
...
_Figure 6: Predicted vs. true target values for random forest model (separate models for registered vs. casual customers)_
...
## [8: Natural language processing of webscraped lyrics](https://github.com/piwi3/nlp_for_lyrics)
...
_Figure 8: Tongue shaped word cloud of 100 most used words in lyrics for 'The Rolling Stones'_


## [9: Metabase dashboard based on a PostgreSQL DB using AWS (RDS/EC2)](https://github.com/piwi3/psql_and_dashboard_aws)
...
## [10: Visualization of gapminder data through GIFs](https://github.com/piwi3/gap_minder_gif)
...
_Figure 10: CO2 vs. income over time (gapminder data)_<br/>
